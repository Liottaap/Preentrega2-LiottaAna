...
function Faqs () {
    return(
        <main className="flex flex-col justify-between">
            <h1 className="text-5xl text-center w-full pb-4 border-b-2 border-primary">FAQS</h1>
            <section className="flex ">
                <div className="w-1/2 flex flex-col gap-10 items-start pl-10 pr-10 pt-10  mt-10">
